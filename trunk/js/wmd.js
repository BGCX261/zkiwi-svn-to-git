...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>Hình ảnh</b></p><p>Bạn có thể thêm Title cho hình</p><p>Ví dụ:<br />http://axample.com/images/cloud1.jpg   \"Optional title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>Enter the web address.</b></p><p>Bạn có thể thêm Title cho link</p><p>Ví dụ:<br />http://axample.com/   \"Optional title\"</p>";
	...
	var helpLink = "http://helps.example.com/";
	var helpHoverTitle = "Hướng dẫn";
